...
PROJECT_NAME ?= provider-exoscale-sos
PROJECT_REPO ?= github.com/exoscale/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 6.41.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-aws
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-aws_$(TERRAFORM_PROVIDER_VERSION)
...
xpkg.build.provider-exoscale-sos: do.build.images
