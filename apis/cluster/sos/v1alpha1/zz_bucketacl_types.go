...
type BucketACLInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/exoscale/provider-exoscale-sos/apis/cluster/sos/v1alpha1.Bucket
...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,sos}
